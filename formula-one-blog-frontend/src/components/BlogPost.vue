  ...
  <div :class="noUserClass">
    ...
    <div class="blog-photo">
      <img
        ...
        :alt="post.title"
      />
      <img v-else :src="getImageUrl(post.blogCoverPhoto)" :alt="post.title" />
    </div>
  </div>
</template>
...
// Class for showing posts
const noUserClass = computed({
  get() {
    return !isUser.value ? "blog-wrapper no-user" : "blog-wrapper";
  },
});
</script>
